...
$sql = "SELECT  *,CONCAT(firstname,' ',lastname) as name FROM user_master where mode = 0";
...
{
  $sql = "SELECT  *,CONCAT(firstname,' ',lastname) as name FROM user_master where mode = 1";
...
//office bearer
  ...
  $sql = "SELECT  *,CONCAT(firstname,' ',lastname) as name FROM user_master where mode = 2";
